            ...
            q.push(entry, err => {
                ...
                if (err) {
                    ...
                    if (!qEntry.error && qEntry instanceof ObjectQueueEntry) {
                        ...
                        if (!this._metricsStore[qEntry.getSite()]) {
                            this._metricsStore[qEntry.getSite()] = {
                                ops: 1,
                                bytes,
                            };
                        } else {
                            this._metricsStore[qEntry.getSite()].ops++;
                            this._metricsStore[qEntry.getSite()].bytes += bytes;
                        }
                    }
                }
            });
