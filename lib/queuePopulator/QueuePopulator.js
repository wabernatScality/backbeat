...
const RetryProducer = require('../RetryProducer');
const RetryConsumer = require('../RetryConsumer');
...
class QueuePopulator {
    ...
    open(cb) {
        ...
        async.series([
            ...
            next => this._setupRetryClients(next),
    ...
    _setupRetryClients(cb) {
        console.log('SETTING UP RETRY CLIENTS');
