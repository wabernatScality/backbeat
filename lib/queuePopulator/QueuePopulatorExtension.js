...
class QueuePopulatorExtension {
    ...
    publish(topic, key, message) {
        this.log.info('QueuePopulatorExtension.publish');
        this.log.info(`value of this._batch value ${this._batch}`);
        assert(this._batch,
    ...
    setBatch(batch) {
        this._batch = batch;
        this.log.info('QueuePopulatorExtension.setBatch');
        this.log.info(`value of this._batch value ${this._batch}`);
    }

    endBatch() {
        this._batch = null;
        this.log.info('QueuePopulatorExtension.endBatch');
        this.log.info(`value of this._batch value ${this._batch}`);
    }
}
